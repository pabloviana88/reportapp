...
public class MyReportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Manager1=inflater.inflate(R.layout.fragment_my_report,container,false);
        ...
        TextView etiqueta_misre=(TextView)Manager1.findViewById(R.id.etiqueta_misreportes); etiqueta_misre.setTypeface(Light);
    ...
    public void consultarListaDatosCache(){
        ...
        Cursor cursor=db.rawQuery("SELECT * FROM "+Utilidades2.TABLA_DATOS, null);
    ...
    public void almanecenarCache(
        ...
        Long idResultante=db.insert(Utilidades2.TABLA_DATOS, Utilidades.CAMPO_ID, values);
        db.close();
    }
                ...
                if(response.isSuccessful()) {
                    ...
                    if (count>0) {
                        ...
                        for (i = 0; i < ListaReporte.size(); i++) {
                            ...
                            id=p.getId();
                            almanecenarCache(id,p.getId_reporte(),p.getUsuario(),p.getDireccion(),p.getLatitud(),p.getLongitud(),p.getTipo(),p.getFecha(),p.getFoto(),p.getFolio(),p.getEstatus(),p.getColonia(),p.getCategoria(),p.getCruzamiento(),p.getDescripcion(),p.getHora(), p.getLikes(), p.getLike_usuario());
                        }
                    }
                    consultarListaDatosCache();
                }
