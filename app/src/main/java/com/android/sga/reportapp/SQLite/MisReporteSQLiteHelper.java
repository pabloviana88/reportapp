...
public class MisReporteSQLiteHelper extends SQLiteOpenHelper {
    ...
    String sqlCache="CREATE TABLE MisReportes (" +
            "id INTEGER," +
            "id_reporte TEXT," +
            "usuario TEXT," +
            "direccion TEXT," +
    ...
    public MisReporteSQLiteHelper(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS MisReportes");
