...
public class datosReporte {
    ...
    public datosReporte(int id,String id_reporte, String usuario, String direccion, String latitud, String longitud, String tipo, String fecha, String foto, String folio, String estatus, String colonia, String categoria, String cruzamiento, String descripcion,String hora,int likes, String like_usuario, int comentarios) {
        this.id = id;
